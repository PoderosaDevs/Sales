            ...
            <div className="flex items-center justify-between">
              {isProductInCart(produto.id) ? (
                <div className="flex w-full items-center justify-between">
                  <button
                    className="w-full flex justify-center items-center gap-2 bg-red-700 text-sm text-white px-3 py-2 rounded hover:bg-red-500 transition"
                ...
                <div className="flex w-full ">
                  <button
                    className="w-full flex justify-center items-center gap-2 bg-indigo-600 text-sm px-1 py-1  text-white rounded hover:bg-indigo-700 transition md:px-3 md:py-2 "
