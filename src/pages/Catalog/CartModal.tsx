          ...
          <div className="space-y-8 pb-4">
            ...
            <div className="min-h-[200px]">
              {cartItems.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 md:py-24 space-y-6 bg-white/[0.01] border-2 border-dashed border-white/5 rounded-[40px]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 relative z-10">
                ...
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0a0a0c] border border-white/10 text-white rounded-2xl px-6 py-4 md:py-5 outline-none focus:ring-2 focus:ring-emerald-500/40 transition-all [color-scheme:dark]"
                  />
                </div>
              </div>

              <div className="mt-8 md:mt-12 flex items-center justify-between gap-6 relative z-10">
